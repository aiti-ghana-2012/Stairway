...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reservation.roomnumber'
        db.add_column('hostels_reservation', 'roomnumber', self.gf('django.db.models.fields.CharField')(default=0, max_length=60), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reservation.roomnumber'
        db.delete_column('hostels_reservation', 'roomnumber')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 10, 27, 7, 463395)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 10, 27, 7, 463258)'}),
