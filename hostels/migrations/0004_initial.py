...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hostels_reservation', (
            ...
            ('roomnumber', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 10, 14, 6, 81810)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 10, 14, 6, 81676)'}),
