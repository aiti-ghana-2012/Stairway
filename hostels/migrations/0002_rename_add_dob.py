...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # rename hostel_manager_name to hostel_manager_details in Hostel
        db.rename_column('hostels_hostel', 'hostel_manager_name', 'hostel_manager_details')

        # added DOB field to Student



    def backwards(self, orm):
        # rename hostel_manager_details to hostel_manager_name
        db.rename_column('hostels_hostel', 'hostel_manager_details', 'hostel_manager_name')

        # remove DOB field from Student
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 9, 6, 46, 193336)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 9, 6, 46, 193196)'}),
